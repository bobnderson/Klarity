...
function useValidation(options) {
  ...
  const previousValidationErrorRef = React7.useRef(validator.valueManager.defaultErrorState);
...
var usePickerValue = ({
  ...
  } = React11.useRef(inValueWithoutRenderTimezone !== void 0);
  const [previousTimezoneProp, setPreviousTimezoneProp] = React11.useState(timezoneProp);
  if (true) {
    React11.useEffect(() => {
...
var PickersLayout = React19.forwardRef(function PickersLayout2(inProps, ref) {
  ...
  return (0, import_jsx_runtime7.jsxs)(PickersLayoutRoot, {
    ...
    children: [isLandscape ? shortcuts : toolbar, isLandscape ? toolbar : shortcuts, (0, import_jsx_runtime7.jsx)(PickersLayoutContentWrapper, {
      ...
      children: wrapperVariant === "desktop" ? (0, import_jsx_runtime7.jsxs)(React19.Fragment, {
        children: [content, tabs]
      }) : (0, import_jsx_runtime7.jsxs)(React19.Fragment, {
...
var useDesktopPicker = (_ref) => {
  ...
  const renderPicker = () => (0, import_jsx_runtime9.jsxs)(PickersProvider, {
    ...
    children: [(0, import_jsx_runtime9.jsx)(Field, _extends({}, fieldProps, {
      ...
      shouldRestoreFocus,
      reduceAnimations,
      children: (0, import_jsx_runtime9.jsx)(Layout, _extends({}, layoutProps, slotProps?.layout, {
        slots,
        slotProps,
...
var useIsDateDisabled = ({
  ...
  const adapter = useLocalizationContext();
  return React22.useCallback((day) => validateDate({
    adapter,
    value: day,
    timezone,
    props: {
...
var useCalendarState = (params) => {
  ...
  const utils = useUtils();
  const reducerFn = React23.useRef(createCalendarStateReducer(Boolean(reduceAnimations), disableSwitchToMonthOnDayFocus, utils)).current;
  ...
  const handleChangeMonth = React23.useCallback((payload) => {
    dispatch(_extends({
      type: "changeMonth"
    }, payload));
    if (onMonthChange) {
  ...
  const changeMonth = React23.useCallback((newDate) => {
...
var MonthCalendar = React29.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  const [focusedMonth, setFocusedMonth] = React29.useState(() => selectedMonth || utils.getMonth(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "MonthCalendar",
    state: "hasFocus",
    controlled: hasFocus,
  ...
  const isMonthDisabled = React29.useCallback((dateToValidate) => {
    const firstEnabledMonth = utils.startOfMonth(disablePast && utils.isAfter(now, minDate) ? now : minDate);
    const lastEnabledMonth = utils.startOfMonth(disableFuture && utils.isBefore(now, maxDate) ? now : maxDate);
...
var YearCalendar = React31.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  const [focusedYear, setFocusedYear] = React31.useState(() => selectedYear || utils.getYear(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
...
var useMobilePicker = (_ref) => {
  ...
  const fieldRef = React37.useRef(null);
  const labelId = useId();
  const isToolbarHidden = innerSlotProps?.toolbar?.hidden ?? false;
  const {
    open,
  ...
  const renderPicker = () => (0, import_jsx_runtime23.jsxs)(PickersProvider, {
    ...
    children: [(0, import_jsx_runtime23.jsx)(Field, _extends({}, fieldProps, {
      ...
      slots,
      slotProps,
      children: (0, import_jsx_runtime23.jsx)(Layout, _extends({}, layoutProps, slotProps?.layout, {
        slots,
        slotProps,
        children: renderCurrentView()
      }))
...
var useClearableField = (props) => {
  ...
  return _extends({}, other, {
    InputProps: _extends({}, InputProps, {
      endAdornment: (0, import_jsx_runtime24.jsxs)(React38.Fragment, {
...
var _excluded20 = ["slots", "slotProps", "elements", "sectionListRef"];
...
function PickersSection(props) {
  ...
  return (0, import_jsx_runtime25.jsxs)(Section, _extends({}, sectionProps, {
    children: [(0, import_jsx_runtime25.jsx)(SectionSeparator, _extends({}, sectionSeparatorBeforeProps)), (0, import_jsx_runtime25.jsx)(SectionContent, _extends({}, sectionContentProps)), (0, import_jsx_runtime25.jsx)(SectionSeparator, _extends({}, sectionSeparatorAfterProps))]
  }));
}
...
var PickersSectionList = React42.forwardRef(function PickersSectionList2(inProps, ref) {
  ...
  return (0, import_jsx_runtime25.jsx)(Root, _extends({}, rootProps, {
    children: rootProps.contentEditable ? elements.map(({
      ...
      before,
      after
    }) => `${before.children}${content.children}${after.children}`).join("") : (0, import_jsx_runtime25.jsx)(React42.Fragment, {
...
var _excluded21 = ["elements", "areAllSectionsEmpty", "defaultValue", "label", "value", "onChange", "id", "autoFocus", "endAdornment", "startAdornment", "renderSuffix", "slots", "slotProps", "contentEditable", "tabIndex", "onInput", "onPaste", "onKeyDown", "fullWidth", "name", "readOnly", "inputProps", "inputRef", "sectionListRef"];
...
var _excluded28 = ["children", "className", "label", "notched", "shrink"];
...
function Outline(props) {
  ...
  return (0, import_jsx_runtime27.jsx)(OutlineRoot, _extends({
    ...
    children: (0, import_jsx_runtime27.jsx)(OutlineLegend, {
      ownerState,
      children: withLabel ? (0, import_jsx_runtime27.jsx)(OutlineLabel, {
        children: label
      }) : (
...
var _excluded29 = ["label", "autoFocus", "ownerState", "notched"];
...
var PickersOutlinedInput = React45.forwardRef(function PickersOutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime28.jsx)(PickersInputBase, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime28.jsx)(Outline, {
      ...
      label: label != null && label !== "" && muiFormControl?.required ? (0, import_jsx_runtime28.jsxs)(React45.Fragment, {
        children: [label, " ", "*"]
      }) : label,
      ownerState
    })
...
var _excluded31 = ["label", "autoFocus", "disableUnderline", "ownerState"];
...
var _excluded34 = ["onFocus", "onBlur", "className", "color", "disabled", "error", "variant", "required", "InputProps", "inputProps", "inputRef", "sectionListRef", "elements", "areAllSectionsEmpty", "onClick", "onKeyDown", "onKeyUp", "onPaste", "onInput", "endAdornment", "startAdornment", "tabIndex", "contentEditable", "focused", "value", "onChange", "fullWidth", "id", "name", "helperText", "FormHelperTextProps", "label", "InputLabelProps"];
...
var _excluded36 = ["onPaste", "onKeyDown", "inputMode", "readOnly", "InputProps", "inputProps", "inputRef"];
...
var useFieldState = (params) => {
  ...
  const localizedDigits = React49.useMemo(() => getLocalizedDigits(utils), [utils]);
  const sectionsValueBoundaries = React49.useMemo(() => getSectionsBoundaries(utils, localizedDigits, timezone), [utils, localizedDigits, timezone]);
  const getSectionsFromValue = React49.useCallback((value, fallbackSections = null) => fieldValueManager.getSectionsFromValue(utils, value, fallbackSections, (date) => buildSectionsFromFormat({
    utils,
...
var useFieldV7TextField = (params) => {
  ...
  const interactions = React51.useMemo(() => ({
    syncSelectionToDOM: () => {
    ...
    getActiveSectionIndexFromDOM: () => {
      const activeElement2 = getActiveElement(document);
  ...
  const handleContainerBlur = useEventCallback_default((...args) => {
    ...
    setTimeout(() => {
      ...
      const activeElement2 = getActiveElement(document);
      const shouldBlur = !sectionListRef.current.getRoot().contains(activeElement2);
      if (shouldBlur) {
        setFocused(false);
  ...
  const sectionBoundaries = React51.useMemo(() => {
    ...
    return state.sections.map((section, index) => {
      ...
      return {
        ...
        content: {
          ...
          [parseInt(React51.version, 10) >= 17 ? "enterKeyHint" : "enterkeyhint"]: isEditable ? "next" : void 0,
...
var useFieldV6TextField = (params) => {
  const isRtl = useRtl();
  const focusTimeoutRef = React52.useRef(void 0);
  const selectionSyncTimeoutRef = React52.useRef(void 0);
  const {
    forwardedProps: {
      onFocus,
      onClick,
  ...
  const interactions = React52.useMemo(() => ({
    syncSelectionToDOM: () => {
      if (!inputRef.current) {
        return;
      }
...
var useField = (params) => {
  ...
  const inputError = React53.useMemo(() => {
    if (error !== void 0) {
      return error;
    }
...
//# sourceMappingURL=chunk-IYUIBBVV.js.map
