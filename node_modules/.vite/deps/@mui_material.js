...
var FormControlLabel = React35.forwardRef(function FormControlLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime43.jsxs)(FormControlLabelRoot, {
    ...
    ref,
    ...other,
    children: [React35.cloneElement(control, controlProps), required ? (0, import_jsx_runtime43.jsxs)("div", {
...
var Tooltip = React67.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React67.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime77.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  const isRtl = useRtl();
  ...
  return (0, import_jsx_runtime77.jsxs)(React67.Fragment, {
    children: [React67.cloneElement(children, childrenProps), (0, import_jsx_runtime77.jsx)(PopperSlot, {
...
var StepButton = React75.forwardRef(function StepButton2(inProps, ref) {
  ...
  const child = isMuiElement_default(children, ["StepLabel"]) ? React75.cloneElement(children, childProps) : (0, import_jsx_runtime86.jsx)(StepLabel_default, {
    ...childProps,
    children
  });
