...
import { CONSIGNMENT_TYPES } from "../../data/maritime/logisticsData";
import {
  Dialog,
  DialogTitle,
  DialogContent,
...
export function VoyageManifestDialog({
  ...
  // The following section appears to be markdown content intended for a different file (e.g., walkthrough.md).
  // Inserting it directly into this JavaScript/TypeScript file would cause syntax errors.
  // As per instructions to ensure the resulting file is syntactically correct, this content cannot be added here.
  // If this content was meant for a different file, please provide that file for editing.
  // If it was intended to be a comment, please specify.
  ...
  const handleGeneratePDF = () => {
    ...
    doc.setFontSize(18);
    doc.setTextColor(40);
    doc.text("VOYAGE MANIFEST", pageWidth / 2, 15, { align: "center" });
    ...
    doc.text(
      `Departure: ${dayjs(voyage.departureDateTime).format("DD MMM YYYY HH:mm")}`,
      100,
      45,
    );
    ...
    const tableData = assignedRequests.flatMap((req) =>
      req.items.map((item) => {
        const consignment = CONSIGNMENT_TYPES.find(
          (c) => (c as any).categoryId === item.categoryId,
        );
        const itemTypeLabel = item.itemTypeName || item.itemTypeId;
  ...
  return (
    ...
    >
      ...
      >
        {/* Condensed Header & Capacity Rows */}
        <Box
          sx={{
            p: 2,
            bgcolor: "var(--bg-soft)",
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              ...
              <Box>
                ...
                <Typography variant="body2">
                  ...
                  <span style={{ color: "var(--muted)", margin: "0 4px" }}>
                    /
                  </span>
                  ...
                  <Typography
                    ...
                    sx={{
                      ml: 1,
                      color:
                        remainingWeight < 10 ? "error.main" : "success.main",
                      fontWeight: 600,
                    }}
                  >
                        ...
                        >
                          ...
                          <Tooltip title="Delete Item">
                            <IconButton
                              ...
                              disabled={
                                !!processingRequestId || !!processingItemId
                              }
                              sx={{
                                color: "var(--muted)",
