...
export default function AviationApprovalPage() {
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      setTimeout(() => navigate("/aviation-planner"), 2000);
    } catch (err) {
          ...
          >
            ...
            <Grid container spacing={3} sx={{ mb: 4 }}>
              ...
              <Grid size={{ xs: 6, sm: 3 }}>
                ...
                <Typography variant="body2" fontWeight={700}>
                  {dayjs(request.earliestDeparture).format("HH:mm")}
                </Typography>
              </Grid>
              <Grid size={{ xs: 6, sm: 3 }}>
                <Typography
        ...
        <Grid size={{ xs: 12, md: 4 }}>
          ...
          >
            ...
            <Button
              ...
              sx={{ py: 1.5, borderRadius: "12px", mb: 2, fontWeight: 700 }}
            >
              Approve Flight
            </Button>
