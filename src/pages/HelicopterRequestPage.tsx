...
export function HelicopterRequestPage() {
  ...
  const handleCreateNew = () => {
    setEditingRequest({
      ...
      tripType: "OneWay",
      lifting: "Normal",
      costCentre: "6", // Default Aviation Cost Centre
      businessUnitId: "Aviation", // Default BU if applicable, though usually selected
      notify: [],
    } as MovementRequest);
    setIsReadOnly(false);
    setView("form");
                        ...
                        >
                          ...
                          >
                            ...
                            <Chip
                              ...
                              size="small"
                              sx={{
                                bgcolor: `${status.color}.main`, // Assuming MUI color
                                color: "#fff",
                                fontWeight: 700,
                                fontSize: "0.65rem",
                                height: 22,
      ...
      >
        <Button
          ...
          sx={{
            ...
            color: "#1a1a1a",
            fontWeight: 800,
            boxShadow: "0 8px 32px rgba(255, 178, 0, 0.3)",
            "&:hover": {
              bgcolor: "var(--accent-hover)",
              transform: "translateY(-2px)",
              boxShadow: "0 12px 48px rgba(255, 178, 0, 0.4)",
            },
